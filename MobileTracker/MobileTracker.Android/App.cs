...
namespace MobileTracker.Droid
{
    public class App
    {
        ...
        public MobileTracker9000LocationService LocationService
        {
            get
            {
        ...
        public static void StartLocationService()
        {
            ...
            new Task(() => {
                ...
                Application.Context.StartService(new Intent(Application.Context, typeof(MobileTracker9000LocationService)));

                // bind our service (Android goes and finds the running service by type, and puts a reference
                // on the binder to that service)
                // The Intent tells the OS where to find our Service (the Context) and the Type of Service
                // we're looking for (LocationService)
                Intent locationServiceIntent = new Intent(Application.Context, typeof(MobileTracker9000LocationService));
